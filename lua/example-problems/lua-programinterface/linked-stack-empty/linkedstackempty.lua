...
checker = programinterface.program_checker("/home/codepotato/workspacee/oneUp/lua/example-problems/lua-programinterface/linked-stack-empty","LinkedStack.java","javac *.java",10,tests)

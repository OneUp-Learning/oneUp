...
from Students.models import Student, StudentRegisteredCourses, StudentChallenges, StudentActivities, StudentCourseSkills
...
def studentSummary(request):
    ...
    context_dict['user_range'] = zip(range(1,courseStudents.count()+1),userID,first_Name,last_Name,user_Avatar, sc_totalStudentScore, 
                                     sc_totalStudentPossibleScore, act_totalStudentScore, act_totalStudentPossibleScore,
                                     wc_totalStudentUniqueTaken, wc_totalStudentAttempts, user_XP, user_VC)

...
def classAchievements(request):
    ...
    challenges = Challenges.objects.filter(courseID=currentCourse, isGraded=True,  isVisible=True).exclude(endTimestamp="2999-12-31 18:59:00").order_by('endTimestamp')

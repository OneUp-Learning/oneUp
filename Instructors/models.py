...
class Challenges(models.Model):
    ...
    feedbackCorrectAnswer = models.CharField(max_length=500, default="")
    feedbackIncorrectAnswer = models.CharField(max_length=500, default="")
    instructorNotes = models.CharField(max_length=500, default="")

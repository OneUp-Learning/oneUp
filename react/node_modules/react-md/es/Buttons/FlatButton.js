...
var FlatButton = function (_PureComponent) {
  ...
  FlatButton.prototype.render = function render() {
    return React.createElement(Button, _extends({}, this.props, { flat: true }));
  };
...
FlatButton.propTypes = {
  ...
  deprecated: deprecated('The behavior of the `FlatButton` can be achieved with the `Button` component ' + 'without the additional bundle size. Switch to the `Button` component and add a ' + 'prop `flat`.')
};

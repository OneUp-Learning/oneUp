...
checker = programinterface.program_checker("/home/codepotato/workspacee/oneUp/lua/example-problems/lua-programinterface/array-stack-push","ArrayStack.java","javac *.java",10,tests)

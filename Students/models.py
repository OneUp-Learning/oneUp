...
class StudentRegisteredCourses(models.Model):
    ...
    attendanceStreakStartDate = models.DateTimeField(default=current_localtime)
...
class StudentChallenges(models.Model):
    ...
    startTimestamp = models.DateTimeField(default=current_localtime)
    endTimestamp = models.DateTimeField(default=current_localtime)
...
class StudentBadges(models.Model):
    ...
    timestamp = models.DateTimeField(default=current_localtime, blank=True) # AV # Timestamp for badge assignment date
    def __str__(self):              
...
class StudentVirtualCurrency(models.Model):
    ...
    timestamp = models.DateTimeField(default=current_localtime) # AV # Timestamp for badge assignment date
...
class StudentGoalSetting(models.Model):
    ...
    timestamp = models.DateTimeField(default=current_localtime) # AV # Timestamp for date the goal was created
...
class StudentActivities(models.Model):
    ...
    timestamp = models.DateTimeField(default= current_localtime, verbose_name="Grading Timestamp") # represents when the activity was graded (if it has been)
    hasTimestamp = models.BooleanField(default=False) # Flags used to determine if the timestamp should be used or not

    submissionTimestamp = models.DateTimeField(default= current_localtime, verbose_name="Latest submission timestamp") # represents when the activity was submitted
...
class StudentAttendance(models.Model):
    ...
    studentID = models.ForeignKey(Student, on_delete=models.CASCADE, verbose_name="the related student", db_index=True)
    courseID = models.ForeignKey(Courses, on_delete=models.CASCADE, verbose_name = "Course Name", db_index=True, default=1)      
    timestamp = models.DateTimeField(default= current_localtime)
...
class StudentEventLog(models.Model):
    ...
    timestamp = models.DateTimeField(default=current_localtime, verbose_name="timestamp", db_index=True)
...
class StudentVirtualCurrencyTransactions(models.Model):
    ...
    timestamp = models.DateTimeField(default=current_localtime, verbose_name="timestamp", db_index=True, blank=True, null=True)
...
class StudentLeaderboardHistory(models.Model):
    ...
    startTimestamp = models.DateTimeField(default=current_localtime, verbose_name="Start Timestamp", db_index=True)
    endTimestamp = models.DateTimeField(default=current_localtime, null=True, blank=True, verbose_name="End Timestamp", db_index=True)
...
class DuelChallenges(models.Model): 
    ...
    sendTime = models.DateTimeField(default=current_localtime, verbose_name="Send Timestamp", db_index=True)
    acceptTime = models.DateTimeField(default=current_localtime, verbose_name="Accept Timestamp", db_index=True)
...
class Callouts(models.Model): 
    ...
    sendTime = models.DateTimeField(default=current_localtime, verbose_name="Send Timestamp", db_index=True)
    endTime = models.DateTimeField(default=current_localtime, verbose_name="End Time", db_index=True)
    customMessage = models.CharField(max_length=6000, default='')
...
class CalloutStats(models.Model):
    ...
    submitTime = models.DateTimeField(default=current_localtime, verbose_name="Send Timestamp", db_index=True) # record submit time if there is any submit
...
class StudentStreaks(models.Model):
    ...
    studentID = models.ForeignKey(Student, on_delete=models.CASCADE, verbose_name="the related student", db_index=True)
    courseID = models.ForeignKey(Courses, on_delete=models.CASCADE, verbose_name="the related course", db_index=True)
    streakStartDate = models.DateTimeField(default=current_localtime, null=True, blank=True, verbose_name="The date the streak reset on")
...
class studentFlashCards(models.Model):
    ...
    studyDate = models.DateTimeField(default=current_localtime, verbose_name="the ideal date the flash card should reappear", db_index=True)
